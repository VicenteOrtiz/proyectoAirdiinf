      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Hotelrooms</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
          	<div class="row">
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			<h4 class="mb-5">Purchase Summary</h4>
          			<form method="POST" action="/reserve/room">
          				<p><strong>Nombre Hotel: {{$room->Hotel->hotelName}}</strong></p>
						...
						<div>
							<button type="submit" class="btn btn-primary py-3">Proceder a pagar</button>
						</div>	
