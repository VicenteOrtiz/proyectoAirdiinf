      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.html">Principal</a></span> <span class="mr-2"><a href="hotel.html">Habitaciones de hotel</a></span> </p>
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Habitaciones de Hotel</h1>
          </div>
        </div>
      </div>
    </div>
          				...
          				<form action="/habitacion/comprar" method="post">
          					...
          					<div class="fields">
          						<div class="form-group">
          							<h4>Numero Habitacion - Numero de Camas - Precio por Dia</h4>
