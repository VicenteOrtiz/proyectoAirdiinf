          ...
          <div class="col-lg-9">
          	<div class="row">
          		...
          		<div class="col-md-12 hotel-single ftco-animate mb-5 mt-4">
          			<h4 class="mb-5">Verifica los asientos disponibles</h4>
          			<div class="sidebar-wrap bg-light ftco-animate">
          				<h2>Letra de asiento - Numero de fila</h2>
          					...
          					<div class="fields">
          						<div class="form-group">
          							<div class="select-wrap one-third">
          								...
          								<select name="seat_id" id="seat_id" title="Seat" class="form-control selectpicker" placeholder="Keyword search">
	                      					@foreach($seats as $seat)
	                      					<option value="{{$seat->id}}">{{$seat->seat_letter}} - {{$seat->row}}</option>
	                      					@endforeach
	                    				</select>
          							</div>
          						</div>
