...
@section('content')
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
          		...
          		<div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
						...
						@csrf
          				<div class="sidebar-wrap bg-light ftco-animate">
          					...
          					<p>Asiento del vuelo de ida</p>
          					<select name="firstSeat" class="form-control">
          						@foreach($firstSeats as $firstSeat)
								<option value="{{$firstSeat->id}}">{{$firstSeat->seat_letter}} - {{$firstSeat->row}}</option>
								@endforeach
							</select>
							<p>Asiento del vuelo de vuelta</p>
							<select name="secondSeat" class="form-control">
								@foreach($secondSeats as $secondSeat)
								<option value="{{$secondSeat->id}}">{{$secondSeat->seat_letter}} - {{$secondSeat->row}}</option>
								@endforeach
							</select>
          					<div>
							<div>
		...
		<div>
			<button type="submit" class="btn btn-primary py-3 px-5">Proceder a pagar</button>
		</div>
          				</div>
          				</form>
          		</div>
