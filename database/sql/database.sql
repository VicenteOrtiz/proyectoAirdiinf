...
alter table 
  "reserves" 
add 
  constraint "reserves_insurence_id_foreign" foreign key ("insurence_id") references "insurences" ("id");
alter table 
  "reserves" 
add 
...
alter table 
  "users" 
add 
  constraint "users_record_id_foreign" foreign key ("record_id") references "records" ("id");
alter table 
  "users" 
add 
...
alter table 
  "flightreserves" 
add 
  constraint "flightreserves_flight_id_foreign" foreign key ("flight_id") references "flights" ("id");
alter table 
  "flightreserves" 
add 
  constraint "flightreserves_reserve_id_foreign" foreign key ("reserve_id") references "reserves" ("id");
